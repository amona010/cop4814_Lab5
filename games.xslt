      ...
      <html>
        <body>
          <xsl:variable name="header">
            <tr>
              <th style="background-color: #00008B;">Date</th>
              <th style="background-color: #00008B;">Home</th>
              <th style="background-color: #00008B;">Visitor</th>
            </tr>
          </xsl:variable>
          <xsl:variable name="title1">
            <tr>
              <th colspan="3" style="color:blue; font-size: 100%;">Basketball Scores, Fall 2017</th>
            </tr>
          </xsl:variable>

          <xsl:variable name="title2">
            <tr>
              <th colspan="3" style="color:blue; font-size: 100%;">Home Games at Miami</th>
            </tr>
          </xsl:variable>
